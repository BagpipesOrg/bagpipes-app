    ...
    drop: (item, monitor) => {
      if (monitor.isOver({ shallow: true })) {
        ...
        if (item.type === 'NODE') {
          ...
          console.log("CustomInput Dropping NODE item:", item); 
        } else if (item.type === 'PILL') {
          // Handle dropping of PILL type
          newPill = {
            id: item.id,
            text: item.label,
            color: 'blue',
          ...
          console.log("CustomInput Dropping PILL item:", item); 
        }
