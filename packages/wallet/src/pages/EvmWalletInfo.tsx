...
import chainList from './evmChains.json';
import '../styles/EvmWalletInfo.scss';

const { Option } = Select;

// Json file is download from https://chainid.network/chains.json
// eslint-disable-next-line @typescript-eslint/no-var-requires
const typedChainList: NetworkInfo[] = chainList as NetworkInfo[];
  ...
  useEffect(() => {
    const init = async () => {
      ...
      if (_chainId) {
        ...
        setNetwork(chain as NetworkInfo);
